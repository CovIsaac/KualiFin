...
interface ClientDocumentsProps {
  ...
  errors?: Partial<Record<keyof ClientFiles, string>>;
}

export default function ClientDocuments({ clienteFiles, onFileChange, errors = {} }: ClientDocumentsProps) {
  const docKeys = ['INE_doc', 'CURP_doc', 'comprobante_doc'] as const;

  const labelMap: Record<typeof docKeys[number], string> = {
    INE_doc: 'INE',
    CURP_doc: 'CURP',
    comprobante_doc: 'Comprobante de Domicilio',
  };
          ...
          >
            ...
            {clienteFiles[key] ? (
              ...
              <div className="flex flex-col items-center text-gray-500">
                ...
                <span className="text-sm font-medium text-center">{labelMap[key]}</span>
