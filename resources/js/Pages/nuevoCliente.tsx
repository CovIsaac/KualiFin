    ...
    <>
          ...
          <div className="flex items-center gap-6 mb-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-slate-600 font-medium text-lg">
                Registre los datos básicos y documentos del cliente principal
              </p>
            </div>
          </div>

          <div className="w-full h-2 bg-slate-200/50 rounded-full overflow-hidden">
            <div className="h-full bg-gradient-to-r from-blue-500 to-purple-600 rounded-full w-1/2 animate-pulse"></div>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="relative bg-white/80 backdrop-blur-xl border border-white/30 rounded-3xl shadow-xl shadow-blue-500/10 p-8 hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-500">
            <div className="flex items-center gap-4 mb-8 pb-4 border-b border-gradient-to-r from-blue-200/50 to-purple-200/50">
              ...
              <div>
                ...
                <p className="text-slate-600 font-medium">Información personal del cliente principal</p>
              </div>
            </div>
          ...
          <div className="relative bg-white/80 backdrop-blur-xl border border-white/30 rounded-3xl shadow-xl shadow-orange-500/10 p-8 hover:shadow-2xl hover:shadow-orange-500/20 transition-all duration-500">
            <div className="flex items-center gap-4 mb-8 pb-4 border-b border-gradient-to-r from-orange-200/50 to-amber-200/50">
              ...
              <div>
                ...
                <p className="text-slate-600 font-medium">Adjunte los documentos necesarios del cliente</p>
              </div>
            </div>
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-end p-6 bg-white/60 backdrop-blur-xl rounded-2xl border border-white/30 shadow-lg">
            <button
              type="submit"
              disabled={submitting}
              className={`
            ...
            >
              ...
              <span className="relative flex items-center gap-2">
                {submitting ? (
                  ...
                  <>
                    <span>➡️</span>Siguiente: Datos del Aval
                  </>
                )}
              </span>
            </button>
          ...
          <div className="flex items-center gap-6 mb-6">
            ...
            <div className="flex-1">
              <h1 className="text-4xl font-bold bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 bg-clip-text text-transparent mb-2">
                Paso 2: Datos del Aval
              </h1>
              <p className="text-slate-600 font-medium text-lg">
                Registre los datos básicos y documentos del aval del cliente
              </p>
            </div>
          </div>

          <div className="w-full h-2 bg-slate-200/50 rounded-full overflow-hidden">
            <div className="h-full bg-gradient-to-r from-green-500 to-emerald-600 rounded-full w-full animate-pulse"></div>
          </div>
        </div>
      </div>

      <form onSubmit={handleFinalSubmit} className="space-y-8">
        {/* Datos Básicos del Aval */}
        <section className="relative group">
          <div className="absolute inset-0 bg-gradient-to-r from-green-500/5 to-emerald-500/5 rounded-3xl blur-2xl group-hover:blur-xl transition-all duration-500"></div>
          <div className="absolute inset-0 bg-gradient-to-br from-white/60 to-white/30 rounded-3xl"></div>

          <div className="relative bg-white/80 backdrop-blur-xl border border-white/30 rounded-3xl shadow-xl shadow-green-500/10 p-8 hover:shadow-2xl hover:shadow-green-500/20 transition-all duration-500">
            <div className="flex items-center gap-4 mb-8 pb-4 border-b border-gradient-to-r from-green-200/50 to-emerald-200/50">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-br from-green-500 to-emerald-500 rounded-xl blur-md opacity-50"></div>
                <div className="relative w-14 h-14 bg-gradient-to-br from-green-500 to-emerald-500 rounded-xl flex items-center justify-center text-white text-2xl shadow-lg">
                  🤝
                </div>
              </div>
              <div>
                ...
                <p className="text-slate-600 font-medium">Información personal del aval</p>
              </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="md:col-span-2 group">
                <label htmlFor="aval_nombre" className="block text-sm font-bold text-slate-700 mb-3 flex items-center gap-2">
                  <span className="w-2 h-2 bg-gradient-to-r from-green-500 to-emerald-600 rounded-full"></span>
                  Nombre completo <span className="text-red-500 animate-pulse">*</span>
                </label>
                <div className="relative">
              ...
              <div className="group">
                <label htmlFor="aval_edad" className="block text-sm font-bold text-slate-700 mb-3 flex items-center gap-2">
              ...
              <div className="group">
                <label htmlFor="aval_sexo" className="block text-sm font-bold text-slate-700 mb-3 flex items-center gap-2">
                  <span className="w-2 h-2 bg-gradient-to-r from-emerald-500 to-green-600 rounded-full"></span>
                  Sexo <span className="text-red-500 animate-pulse">*</span>
                </label>
                <div className="relative">
                  <select
              ...
              <div className="md:col-span-2 group">
                <label htmlFor="aval_estado_civil" className="block text-sm font-bold text-slate-700 mb-3 flex items-center gap-2">
                  <span className="w-2 h-2 bg-gradient-to-r from-lime-500 to-green-600 rounded-full"></span>
                  Estado Civil <span className="text-red-500 animate-pulse">*</span>
                </label>
                <div className="relative">
                  <select
                    id="aval_estado_civil"
                    name="estado_civil"
                    value={avalForm.estado_civil}
                    onChange={handleAvalChange}
                    required
                    className={`${selectBase} group-hover:shadow-lg group-hover:scale-[1.02]`}
                  >
        ...
        {/* Documentos del Aval */}
        <section className="relative group">
          <div className="absolute inset-0 bg-gradient-to-r from-teal-500/5 to-cyan-500/5 rounded-3xl blur-2xl group-hover:blur-xl transition-all duration-500"></div>
          <div className="absolute inset-0 bg-gradient-to-br from-white/60 to-white/30 rounded-3xl"></div>

          <div className="relative bg-white/80 backdrop-blur-xl border border-white/30 rounded-3xl shadow-xl shadow-teal-500/10 p-8 hover:shadow-2xl hover:shadow-teal-500/20 transition-all duration-500">
            <div className="flex items-center gap-4 mb-8 pb-4 border-b border-gradient-to-r from-teal-200/50 to-cyan-200/50">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-br from-teal-500 to-cyan-500 rounded-xl blur-md opacity-50"></div>
                <div className="relative w-14 h-14 bg-gradient-to-br from-teal-500 to-cyan-500 rounded-xl flex items-center justify-center text-white text-2xl shadow-lg">
                  📎
                </div>
              </div>
              <div>
                ...
                <p className="text-slate-600 font-medium">Adjunte los documentos necesarios del aval</p>
              </div>
            </div>
                ...
                return (
                  <div key={key} className="group">
                    ...
                    <label
                      ...
                      onDragLeave={() => setAvalDragOver(null)}
                      onDrop={(e) => handleAvalDrop(e, key)}
                      className={`
                        relative block w-full h-32 border-2 border-dashed rounded-2xl cursor-pointer 
                        transition-all duration-300 overflow-hidden group-hover:scale-105
                        ${
                          avalDragOver === key
                            ? `border-teal-500 bg-gradient-to-br ${bgGradients[index]} scale-105`
                            : avalForm[key]
                            ? `border-green-500 bg-gradient-to-br from-green-50 to-emerald-50`
                            : `border-slate-300 bg-gradient-to-br ${bgGradients[index]} hover:border-slate-400`
                        }
        ...
        <div className="relative">
          <div className="absolute inset-0 bg-gradient-to-r from-slate-500/5 to-green-500/5 rounded-2xl blur-xl"></div>
          <div className="relative flex flex-col sm:flex-row justify-between gap-4 p-6 bg-white/60 backdrop-blur-xl rounded-2xl border border-white/30 shadow-lg">
            <button
              type="button"
            ...
            >
              ...
              <span className="relative flex items-center gap-2">
                <span>⬅️</span>Volver: Datos del Cliente
              </span>
            </button>
            ...
            <button
              ...
              className={`
                ...
                ${
                  submitting
                    ? 'bg-gradient-to-r from-slate-400 to-slate-500 cursor-not-allowed'
                    : 'bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 hover:shadow-2xl hover:shadow-green-500/50 hover:scale-105'
                }
                text-white shadow-xl
              `}
            >
              ...
              <span className="relative flex items-center gap-2">
                {submitting ? (
                  ...
                  <>
                    <span>💾</span>Guardar Cliente y Aval
                  </>
                )}
              </span>
            </button>
  ...
  return (
    <AuthenticatedLayout>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {currentStep === 1 ? renderClienteForm() : renderAvalForm()}
      </div>
    </AuthenticatedLayout>
  );
}